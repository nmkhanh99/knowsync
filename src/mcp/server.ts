 ...
 */
export async function startMcpServer(db: GraphDB, rootPath?: string, project?: any): Promise<void> {
  const serverName = project?.code ? `knowsync_${project.code}` : 'knowsync';
  ...
  server.tool('knowsync_get_module_overview',
    ...
    async (args) => wrap(() => getModuleOverview(db, args))
  );
  ...
  server.tool('knowsync_suggest_doc_links',
    ...
    async (args) => wrap(() => suggestDocLinks(db, args))
  );
  ...
  server.tool('knowsync_create_doc_link',
    ...
    createDocLinkSchema,
    async (args) => wrap(() => createDocLink(db, args))
  );
  ...
  server.tool('knowsync_validate_links',
    ...
    validateLinksSchema,
    async (_args) => wrap(() => validateLinks(db, {}))
  );
  ...
  server.tool('knowsync_get_doc_section_content',
    ...
    getDocSectionSchema,
    async (args) => wrap(() => getDocSection(db, args))
  );
  ...
  server.tool('knowsync_provide_parse_rules',
    ...
    async (args) => wrap(() => provideParseRules(db, args))
  );

  server.tool('knowsync_build_graph',
    'Trigger full or delta graph build. Indexes code + docs and persists to the knowledge graph. ' +
    'codeSources: explicit code directories to scan (omit to scan full rootPath). ' +
    'docSources: Markdown directories/files to index.',
    buildGraphSchema,
    async (args) => asyncWrap(() => buildGraph(db, args))
  );
  ...
  server.tool('knowsync_get_full_context',
    ...
    async (args) => wrap(() => getFullContext(db, args))
  );
  ...
  server.tool('knowsync_regenerate_doc',
    ...
    regenerateDocSchema,
    async (args) => wrap(() => regenerateDoc(db, args))
  );
  ...
  server.tool('knowsync_get_doc_visualization',
    ...
    async (args) => wrap(() => getDocVisualization(db, args))
  );
  ...
  server.tool('knowsync_get_requirement_trace',
    ...
    async (args) => wrap(() => getRequirementTrace(db, args))
  );
  ...
  server.tool('knowsync_preview_parse_rules',
    ...
    async (args) => asyncWrap(() => previewParseRules(db, args))
  );
  ...
  server.tool('knowsync_preview_apply_parse_rules',
    ...
    async (args) => asyncWrap(() => previewApplyParseRules(db, args))
  );
  ...
  server.tool('knowsync_scan_doc_sources',
    ...
    async (args) => wrap(() => scanDocSources(db, args))
  );
  ...
  server.tool('knowsync_set_visual_docs_config',
    ...
    async (args) => wrap(() => setVisualDocsConfig(db, args))
  );
  ...
  server.tool('knowsync_get_doc_link_marks',
    ...
    async (args) => wrap(() => getDocLinkMarks(db, args))
  );
  ...
  server.tool('knowsync_resolve_doc_link_mark',
    ...
    async (args) => wrap(() => resolveDocLinkMark(db, args))
  );
  ...
  server.tool('knowsync_rule_sets',
    ...
    ruleSetsSchema,
    async (args) => wrap(() => ruleSets(db, args))
  );
  ...
  server.tool('knowsync_rule_links',
    ...
    ruleLinksSchema,
    async (args) => wrap(() => ruleLinks(db, args))
  );

  const transport = new StdioServerTransport();
  await server.connect(transport);
  process.stderr.write(`KnowSync MCP server representing [${project?.code || project?.name || 'global'}] running on stdio\n`);
}
